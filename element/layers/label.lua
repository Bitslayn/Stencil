...
function obj:draw()
	...
	local x = -props.tex_extend[4] + math.lerp(0, state.size.x - label_w + props.tex_extend[2], 0.5)
	local y = -props.tex_extend[1] + math.lerp(0, state.size.y - label_h + props.tex_extend[3], 0.5)
