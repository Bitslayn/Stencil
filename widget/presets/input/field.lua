...
return function(class, super, elem)
	...
	---@field click fun(self: FOXStencil.Widgets.Field, rel_pos: Vector2, true_pos: Vector2, sound_pos: Vector3, state: boolean)?
	---@field hover fun(self: FOXStencil.Widgets.Field, rel_pos: Vector2, true_pos: Vector2, sound_pos: Vector3, state: boolean, changed: boolean)?
	...
	function elem:newField(name, props)
		...
		widg:setProps({
			...
			click = function(_, rel_pos, true_pos, sound_pos, state) end,
		}):setProps(props or {})
